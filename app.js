document.addEventListener('DOMContentLoaded', () => {
  ...
  function initMap() {
    ...
    const topo = L.tileLayer('https://geoserveis.icgc.cat/icc_mapesmultibase/noutm/wmts/topografia/CAT3857/{z}/{x}/{y}.png', {
      attribution: '&copy; ICGC'
    });

    const orto = L.tileLayer('https://geoserveis.icgc.cat/icc_mapesmultibase/noutm/wmts/orto/CAT3857/{z}/{x}/{y}.jpeg', {
      attribution: '&copy; ICGC'
    });
